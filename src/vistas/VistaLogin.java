...
public class VistaLogin extends JFrame {
    ...
    public VistaLogin() {
        ...
        JPanel panelFondo = new JPanel() {
            ...
            // Cargar imagen desde resources (NO ruta absoluta)
            Image fondo = null;

            {
                java.net.URL imgURL = getClass().getResource("/images/portadaLogin.png");
                if (imgURL != null) {
                    fondo = new ImageIcon(imgURL).getImage();
                } else {
                    System.out.println("⚠ No se encontró la imagen: /images/portadaLogin.png");
                }
            }
